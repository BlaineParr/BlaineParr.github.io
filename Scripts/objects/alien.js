...
(function (objects) {
    var Alien = (function (_super) {
         ...
         */
        Alien.prototype._checkBounds = function () {
         ...
         */
        Alien.prototype._fire = function () {
         ...
         */
        Alien.prototype.moveForward = function () {
         ...
         */
        Alien.prototype.changeDirection = function () {
         ...
         */
        Alien.prototype.checkTarget = function () {
         ...
         * or a bullet.
         */
        Alien.prototype.collide = function () {
    ...
    objects.Alien = Alien; //class Alien ends
